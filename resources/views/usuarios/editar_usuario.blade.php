    ...
    <form class="registrar_usuario" action="{{route('update_usuario',$usuario)}}" method="POST">
        ...
        <div class="form_container">
            <div class="from_group">
                <input type="text" id="ID" class="from_input" placeholder="Id" name="id" required maxlength="10" value="{{$usuario->id_user}}">
            </div>
            <div class="from_group">
                <input type="text" id="nombre" class="from_input" placeholder="Nombre" name="nombres" required pattern="^[A-Za-z ]+" maxlength="25" value="{{$usuario->nom_user}}">
            </div>
            <div class="from_group">
                <input type="text" id="apellido" class="from_input" placeholder="Apellido" name="apellidos" required maxlength="25" pattern="^[A-Za-z ]+" value="{{$usuario->apellidos_user}}">
            </div>
            <div class="from_group">
