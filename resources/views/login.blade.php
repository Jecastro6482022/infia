    ...
    <form class="inicio_Secion" method="POST" action="{{route('login')}}">
        ...
        <div class="from_container">
            <div class="from_group">
                <input type="email" id="E-mail" class="from_input" placeholder=" " name="email_user" required>
                <label for="E-mail" class="from_label">E-mail</label>
                <span class="from_line"></span>
            </div>
            <div class="from_group">
                <input type="password" id="password" class="from_input" placeholder=" " name="contraseña_user" required minlength="6">
